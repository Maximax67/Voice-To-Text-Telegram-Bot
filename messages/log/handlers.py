...
ADMIN_BROADCAST_MESSAGE = A_PREFIX + "Admin broadcast! Broadcasted: {}"
ADMIN_BROADCAST_FORWARD = A_PREFIX + "Admin broadcast! Forwarded message!"
ADMIN_BROADCAST_FAIL = ADMIN_COMMAND + "Admin broadcast! Message didn't broadcast to {}: {}"
ADMIN_BROADCAST_FORWARD_FAIL = ADMIN_COMMAND + "Admin broadcast! Message didn't forwarded to {}: {}"
...
BROADCAST_FORWARD = A_PREFIX + "Forwarded message!"
