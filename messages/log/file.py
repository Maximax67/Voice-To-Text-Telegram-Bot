...
UNKNOWN_EXTENSION = U_PREFIX + "File: {}, Unknown file extension"
UNSUPPORTED_FORMAT = U_PREFIX + "File: {}, Unsupported file format: {}"
DOWNLOAD_ERROR = U_PREFIX + "Error downloading: {}, {}"
UNKNOWN_ERROR = U_PREFIX + "Error: {}"
